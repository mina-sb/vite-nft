...
const Card = () => {
  return (
    <div
      className={`${item}   bg-white border  border-gray-200 rounded-lg  dark:bg-gray-800 dark:border-gray-700`}
    >
        ...
        <div className="flex justify-between mb-2 items-center">
          <ul className="flex relative">
            <li>
              <img
                src={client1}
                className="w-7 h-7 rounded-full hover:scale-125 hover:cursor-pointer duration-100"
              />
            </li>
            <li>
              <img
                src={client2}
                className="w-7 h-7 rounded-full absolute left-5 hover:scale-125 hover:cursor-pointer duration-100"
              />
            </li>
            <li>
              <img
                src={client3}
                className="w-7 h-7 rounded-full  absolute left-10 hover:scale-125 hover:cursor-pointer duration-100"
              />
            </li>
          </ul>
